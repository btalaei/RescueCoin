...
Setup
-----
Unpack the files into a directory and run rescuecoin-qt.exe.

Rescuecoin-qt is the original Litecoin client and it builds the backbone of the network.
