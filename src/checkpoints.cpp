...
namespace Checkpoints
{
    ...
    static const CCheckpointData data = {
        &mapCheckpoints,
        1405908934, // * UNIX timestamp of last checkpoint block
        4953,    // * total number of transactions between genesis and last checkpoint
                    //   (the tx=... number in the SetBestChain debug.log lines)
        1300.0     // * estimated number of transactions per day after checkpoint
    };

    static MapCheckpoints mapCheckpointsTestnet =
        boost::assign::map_list_of
        (   546, uint256("0x40d1379815c3ba8028f799677faf36d0c07fbb47019db9b01ea32a0801a3ae0a"))
        ;
