...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 RSCC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 RSCC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 100000000 * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** transaction outputs can only be spent after this number of new blocks (network rule) */
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        // 2.5 minutes = 1 block ... 1 hour = 24 blocks ... 1 day = 576 blocks
        // return dPriority > COIN * 576 / 250;
        // 2.0 minutes = 1 block ... 1 hour = 30 blocks ... 1 day = 720 blocks
        return dPriority > COIN * 720 / 250; // LottoCoin: 720 blocks found a day. Priority cutoff is 1 rescuecoin day / 250 bytes.
    }
